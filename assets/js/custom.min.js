(function($){"use strict";const wind=$(window);const body=$("body");const dataAttr={animateTextAjax:".headefr-fexid .project-title .title-text-header .cat ,[data-dsn-animate=\"ajax\"] , footer"+", .next-project , .root-project",};if(navigator.userAgent.match(/Edge/i)||navigator.userAgent.match(/MSIE 10/i)||navigator.userAgent.match(/MSIE 9/i)){$(".cursor").css("display","none")}
preloader();navBar();var effectScroll=effectScroller();var animate=effectAnimate();effectScroll.start();animate.allInt();reloadAjax();effectBackForward();contactValidator();effctStickyNavBar();function reloadAjax($off){data_overlay();changeColor();background();initMap();LoadingPage();SliderProject();slick_client(wind);dsnAjax($off).ajaxLoad();mouseCirMove($off);slidereProjects();Popup();gallery();viewAllWork();slider().run();$("a.vid").YouTubePopUp();contactValidator()}
function effctStickyNavBar(){wind.off("scroll");let headerSmall=$(".dsn-nav-bar");headerSmall.removeClass("header-stickytop");let bodyScroll=0;var $ofContent=$(".wrapper").offset();var header=$(".header-single-post .container").offset();var post_full_content=$(".post-full-content").offset();var scrDown=0;if(header!==undefined){$ofContent=header}else if($ofContent&&$ofContent.top<=70){$ofContent=post_full_content}
...
scrDown=bodyScroll})}
function preloader(){var preloader=$(".preloader");var preloader_block=preloader.find(".preloader-block");var progress_number=preloader_block.find(".percent");var progress_title=preloader_block.find(".title");var progress_loading=preloader_block.find(".loading");var preloader_bar=preloader.find(".preloader-bar");var preloader_progress=preloader_bar.find(".preloader-progress");var preloader_after=preloader.find(".preloader-after");var preloader_before=preloader.find(".preloader-before");var timer=dsnGrid.pageLoad(0,100,300,function(val){progress_number.text(val);preloader_progress.css("width",val+"%")});wind.on("load",function(){clearInterval(timer);TweenMax.fromTo(preloader_progress,.5,{width:"95%"},{width:"100%",onUpdate:function(){var f=preloader_progress.width()/preloader_progress.parent().width()*100;progress_number.text(parseInt(f,10))},onComplete:function(){TweenMax.to(preloader_bar,.5,{left:"100%"});TweenMax.to(progress_title,0.7,{autoAlpha:0,y:-100});TweenMax.to(progress_loading,0.7,{autoAlpha:0,y:100});TweenMax.to(progress_number,0.7,{autoAlpha:0});TweenMax.to(preloader_before,0.7,{y:"-100%",delay:.7});TweenMax.to(preloader_after,0.7,{y:"100%",delay:.7,onComplete:function(){preloader.addClass("hidden")},})},})})}
function changeColor(){const $isLight=$("[data-dsn-temp=\"light\"]");if($isLight.length>0){body.addClass("v-light");let head_p=$("[data-dsn-header=\"project\"]");if(head_p.length<=0)
body.addClass("menu-light");else if(head_p.hasClass("header-hero-2"))
body.addClass("menu-light");}else body.removeClass("v-light")}
function slidereProjects(){$(".client-see .slick-slider  ").slick({infinite:!0,slidesToShow:1,arrows:!1,dots:!0,fade:!0,cssEase:"linear",});$(" .insights .slick-slider , .our-team .slick-slider , [data-dsn-col=\"2\"] .slick-slider").slick({infinite:!0,slidesToShow:2,arrows:!1,dots:!0,responsive:[{breakpoint:800,settings:{slidesToShow:1,slidesToScroll:1,},},],});$("[data-dsn-col=\"3\"] .slick-slider").slick({infinite:!0,slidesToShow:3,arrows:!1,dots:!0,autoplay:!0,responsive:[{breakpoint:800,settings:{slidesToShow:2,slidesToScroll:2,},},{breakpoint:600,settings:{slidesToShow:1,slidesToScroll:1,},},],})}
function Popup(){let galleryPortfolios=$(".gallery-col .box-im .image-zoom");galleryPortfolios.magnificPopup({delegate:"a",type:"image",closeOnContentClick:!1,closeBtnInside:!1,gallery:{enabled:!0,},zoom:{enabled:!0,duration:300,opener:function(element){return element.find("img")},},})}
function effectAnimate(){var controller=new ScrollMagic.Controller();const eHeaderProject="[data-dsn-header=\"project\"]";const eNextProject="[data-dsn-footer=\"project\"]";return{clearControl:function(){controller=new ScrollMagic.Controller()},isElemntId:function($id){return document.getElementById($id)!==null},headerProject:function(){if($(eHeaderProject).length<=0)return!1;let heroImg=$("#dsn-hero-parallax-img"),heroTitle=$("#dsn-hero-parallax-title"),fillTitle=$("#dsn-hero-parallax-fill-title"),holder=$("#descover-holder"),scale=1.2;if(heroImg.hasClass("parallax-move-element"))
dsnGrid.parallaxMoveElemnt({target:$(eHeaderProject),element:heroImg.find(".cover-bg"),},5,1);var parallax=new TimelineMax();if(heroImg.length>0){let s=heroImg.hasClass("has-top-bottom")?1:1.08;parallax.to(heroImg,1,{force3D:!0,y:"30%",scale:s},0)}
if(heroTitle.length>0){if(heroTitle.hasClass("project-title"))scale=1;parallax.to(heroTitle,.8,{force3D:!0,top:"30%",autoAlpha:0,scale:scale,},0)}
if(fillTitle.length>0){parallax.to(fillTitle,1,{force3D:!0,height:80,},0).to("#dsn-hero-parallax-fill-title h1",1,{force3D:!0,top:0,},0).to(heroTitle.find(".slider-header.slider-header-top"),1,{force3D:!0,height:0,},0)}
if(holder.length>0)
parallax.to(holder,.8,{force3D:!0,bottom:"-10%",autoAlpha:0,},0);if(parallax._totalDuration<=0)return!1;var parallaxProject=new ScrollMagic.Scene({triggerElement:eHeaderProject,triggerHook:0,duration:"100%",}).setTween(parallax).addTo(controller);let video=heroImg.find("video");if(video.length>0||body.hasClass("v-light")){parallaxProject.on("enter",function(){if(video.length>0)
video.get(0).play();if(body.hasClass("v-light")&&!$(eHeaderProject).hasClass("header-hero-2"))
body.removeClass("menu-light");});parallaxProject.on("leave",function(){if(video.length>0)
video.get(0).pause();if(body.hasClass("v-light")&&!$(eHeaderProject).hasClass("header-hero-2"))
body.addClass("menu-light");})}
return parallaxProject},nextProject:function(){let footerImg=$("#dsn-next-parallax-img"),footerTitle=$("#dsn-next-parallax-title");let img=footImg();let title=footTitle();effectScroll.getListener(function(e){if(img!==!1)img.refresh();if(title!==!1)title.refresh();});if(title!==!1&&body.hasClass("v-light")){title.on("progress",function(event){if(event.progress>0.8){body.removeClass("menu-light")}else{body.addClass("menu-light")}})}
function footImg(){if(footerImg.length<=0)return!1;return new ScrollMagic.Scene({triggerElement:eNextProject,triggerHook:1,duration:"100%",}).setTween(TweenMax.to(footerImg,0.7,{force3D:!0,y:"30%",scale:1,},0)).addTo(controller)}
function footTitle(){if(footerTitle.length<=0)return!1;return new ScrollMagic.Scene({triggerElement:eNextProject,triggerHook:.5,duration:"55%",}).setTween(TweenMax.to(footerTitle,0.7,{force3D:!0,top:"0%",opacity:1,ease:Power0.easeNone,},0)).addTo(controller)}},parallaxImg:function(){const moveUp=$("[data-dsn-grid=\"move-up\"]");moveUp.each(function(){let _that=$(this);_that.attr("data-dsn-grid","moveUp");let img=_that.find("img:not(.hidden) , video");let triggerHook=dsnGrid.getUndefinedVal(_that.data("dsn-triggerhook"),1),duration=dsnGrid.getUndefinedVal(_that.data("dsn-duration"),(triggerHook!==1)?"100%":"200%");if(img.length>0){var parallax;if(img.hasClass("has-top-bottom")){let pers=dsnGrid.getUndefinedVal(img.data("dsn-move"),"15%");parallax=TweenMax.to(img,0.8,{force3D:!0,y:pers,ease:Power0.easeNone})}else{let y=dsnGrid.getUndefinedVal(img.data("dsn-y"),"10%");let scale=dsnGrid.getUndefinedVal(img.data("dsn-scale"),1.1);if(triggerHook!==1){img.css("top",0);parallax=TweenMax.to(img,2,{force3D:!0,scale:scale,y:y})}else parallax=TweenMax.to(img,0.7,{force3D:!0,scale:scale,y:y,ease:Power0.easeNone,})}
...
myScrollbar=document.querySelector("#dsn-scrollbar");let hasSc=!body.hasClass("dsn-effect-scroll")||this.isMobile()||myScrollbar===null;if(hasSc&&$print){body.addClass("dsn-mobile")}
return!hasSc},locked:function(){body.addClass(locked_scroll);if(this.isScroller()){let scroll=this.getScrollbar();if(scroll!==undefined){scroll.destroy()}}},unlocked:function(){body.removeClass(locked_scroll);this.start();effctStickyNavBar();animate.allInt();dsnGrid.progressCircle(effectScroll)},getScrollbar:function($id){if($id===undefined){return Scrollbar.get(myScrollbar)}
return Scrollbar.get(document.querySelector($id))},getListener:function($obj){if($obj===undefined)return;var $this=this;if($this.isScroller(!0)){$this.getScrollbar().addListener($obj)}else{wind.on("scroll",$obj)}},start:function(){dsnGrid.scrollTop(0,1);$(".scroll-to").on("click",function(e){e.preventDefault();let sc=wind;if(effectScroll.isScroller(!0))
sc=effectScroll.getScrollbar();TweenLite.to(sc,1.5,{scrollTo:$(".wrapper").offset().top,ease:Expo.easeInOut,})});if(!this.isScroller(!0))return;let dam=0.05;if(this.isMobiles())
...
function LoadingPage(){const filter=$(".filtering");const gallery=$(".gallery");var $gallery=gallery.isotope({itemSelector:".item",transitionDuration:"0.5s",});filter.on("click","button",function(){var filterValue=$(this).attr("data-filter");$gallery.isotope({filter:filterValue,})});filter.on("click","button",function(){$(this).addClass("active").siblings().removeClass("active");let sc=wind;if(effectScroll.isScroller(!0))
sc=effectScroll.getScrollbar();setTimeout(function(){TweenLite.to(sc,1.5,{scrollTo:$gallery.offset().top-150,ease:Expo.easeInOut,})},500)});$gallery.find("video").each(function(){this.pause();let $this=$(this);$this.parents(".item").find("> a").on("mouseenter",function(){$(this).parents(".item").find("video")[0].play()}).on("mouseleave",function(){$(this).parents(".item").find("video")[0].pause()})})}})(jQuery);function SliderProject(){$(".slider-project .swiper-container").each(function($index){new Swiper(this,{slidesPerView:"auto",spaceBetween:60,navigation:{nextEl:$(this).parents(".slider-project").find(".slider-button-next"),prevEl:$(this).parents(".slider-project").find(".slider-button-prev"),},pagination:{el:$(this).parents(".slider-project").find(".swiper-pagination"),type:"fraction",},})})}
function data_overlay(){$("[data-overlay-color]").each(function($index){var _that=$(this);var _color=dsnGrid.removeAttr(_that,"data-overlay-color");_that.addClass("dsn-overlay-"+$index);$("body").append("<style>.dsn-overlay-"+$index+"[data-overlay]:before{background: "+_color+";}</style>")})}(function(){function addPrefetch(href){if(!href)return;try{if(document.querySelector('link[rel="prefetch"][href="'+href+'"]'))return;var l=document.createElement('link');l.rel='prefetch';l.href=href;l.setAttribute('as','document');document.head.appendChild(l)}catch(e){}}
document.addEventListener('DOMContentLoaded',function(){document.body.addEventListener('mouseenter',function(ev){var t=ev.target.closest&&ev.target.closest('a.effect-ajax');if(t){var $t=window.jQuery?window.jQuery(t):null;if($t&&$t.data('dsn-prefetched'))return;var href=t.getAttribute('href');addPrefetch(href);if($t)$t.data('dsn-prefetched',!0);}},!0);document.body.addEventListener('focus',function(ev){var t=ev.target.closest&&ev.target.closest('a.effect-ajax');if(t){var $t=window.jQuery?window.jQuery(t):null;if($t&&$t.data('dsn-prefetched'))return;var href=t.getAttribute('href');addPrefetch(href);if($t)$t.data('dsn-prefetched',!0);}},!0)})})();function background(){var cover=$(".cover-bg, section , [data-image-src]");cover.each(function(){var attr=$(this).attr("data-image-src");if(typeof attr!==typeof undefined&&attr!==!1){$(this).css("background-image","url("+attr+")")}})}
function slick_client(wind){var client_curs=$(".client-curs");if(client_curs.length>0){client_curs.slick({slidesToShow:1,slidesToScroll:1,arrows:!0,infinite:!0,nextArrow:"<i class=\"fas fa-angle-right\"></i>",prevArrow:"<i class=\"fas fa-angle-left\"></i>",cssEase:"cubic-bezier(.9, .03, .41, .49)",speed:700,});if(wind.width()>991){dsnGrid.parallaxMoveElemnt(client_curs.find(".fas.fa-angle-right"),25);dsnGrid.parallaxMoveElemnt(client_curs.find(".fas.fa-angle-left"),25)}}}
function contactValidator(){var contact_form=$("#contact-form");if(contact_form.length<1){return}
contact_form.validator();var $submitButton=contact_form.find('button[type="submit"], button');var originalButtonText=$submitButton.html();contact_form.on("submit",function(e){if(!e.isDefaultPrevented()){e.preventDefault();var url="contact.php";if($submitButton.length>0){$submitButton.prop('disabled',!0);$submitButton.html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Sending...')}
$.ajax({type:"POST",url:url,data:contact_form.serialize(),dataType:"json",timeout:10000,success:function(data){handleFormResponse(data,contact_form,$submitButton,originalButtonText)},error:function(xhr,status,error){try{var data=JSON.parse(xhr.responseText);handleFormResponse(data,contact_form,$submitButton,originalButtonText)}catch(e){console.error("Form submission error (AJAX/Server):",status,error,xhr.responseText);var errorMessage="<div class=\"alert alert-danger alert-dismissible\" role=\"alert\"><button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>Error submitting form. Please try again.</div>";contact_form.find(".messages").html(errorMessage);if($submitButton.length>0){$submitButton.prop('disabled',!1);$submitButton.html(originalButtonText)}}},});return!1}})}
function handleFormResponse(data,contact_form,$submitButton,originalButtonText){var messageAlert="alert-"+data.type;var messageText=data.message;var alertBox="<div class=\"alert "+messageAlert+" alert-dismissible\" role=\"alert\"><button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>"+messageText+"</div>";if(messageAlert&&messageText){contact_form.find(".messages").html(alertBox);if(data.type==='success'){contact_form[0].reset()}}
if($submitButton.length>0){$submitButton.prop('disabled',!1);$submitButton.html(originalButtonText)}
setTimeout(function(){contact_form.find(".messages").html("")},5000)}
function initMap(){var map_id=document.getElementById("map");var map_scropt_id=document.getElementById("map_api");if(map_id===null)return;if(map_scropt_id===null){var GOOGLE_MAP_KEY="AIzaSyA49hGCmzG22gXOfg784H0w8DtKEsSvq7k";var script=document.createElement("script");script.type="text/javascript";script.id="map_api";script.src="https://maps.googleapis.com/maps/api/js?key="+GOOGLE_MAP_KEY;document.body.appendChild(script)}
